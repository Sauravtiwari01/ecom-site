                    ...
                    <div className="table-responsive">
                      <table className="table table-striped">
                        <tbody>
                          ...
                          <tr>
                            <td>Gender</td>
                            <td>{data ? data.gender ? data.gender : <Link to='/update-profile'>Select Gender</Link> : "N/A"}</td>
                          </tr>
                          <tr>
                            <td>DOB</td>
                            <td>{data ? data.dob ? data.dob : <Link to='/update-profile'>Select DOB</Link> : "N/A"}</td>
                          </tr>
